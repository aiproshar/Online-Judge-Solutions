...
//O(n) constrain, so no sorting or greedy approach acceptable
...
//There is something called disjoint union set or something. IDK what is that maybe similar or i accidentally implemented it who knows !
